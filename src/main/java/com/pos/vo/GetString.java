...
/* 100 */       detailsNum = paramDateString.trim().replaceAll("/", "")
/* 101 */         .replaceAll("-", "").replaceAll(":", "")
/* 102 */         .replaceAll(" ", "").substring(0, 12);
/* 103 */       return detailsNum;
/*     */     }
/* 105 */     detailsNum = paramDateString.trim().replaceAll("/", "")
/* 106 */       .replaceAll("-", "").replaceAll(":", "")
/* 107 */       .replaceAll(" ", "").substring(0, 12);
/* 108 */     i = r.nextInt(10);
 ...
 * Qualified Name:     com.pos.vo.GetString
